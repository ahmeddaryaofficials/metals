...
<script type="text/javascript">
        ...
        if (Object.keys(data).length != 0) {
            $.each(data['name'], function(index) {
                ...
                if(index % 5 == 0 && index != 0)
                    tableData += '</tr><tr><td product_data="'+data['code'][index]+'" class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="images/product/'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
                else
                    tableData += '<td product_data="'+data['code'][index]+'" class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="images/product/'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
            });
    ...
    $(document).on('click', '.product-img', function() {
        ...
        if(!customer_id)
            ...
            data = data.split(" ");
            pos = product_code.indexOf(this.getAttribute('product_data'));
            if(pos < 0)
                 alert('Product is not avaialable in the selected warehouse');
            else{
                 productSearch($(this).data('product'));
            }
        }
    });
    //Delete product
